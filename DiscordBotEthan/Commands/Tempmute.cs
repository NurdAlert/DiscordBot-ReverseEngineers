...
namespace DiscordBotEthan.Commands {
    ...
    public class Tempmute : BaseCommandModule {
        ...
        public async Task TempmuteCommand(CommandContext ctx, [Description("The Member to mute")] DiscordMember member, [RemainingText, Description("Length(d/h/m/s) Ex. 7d for 7 Days")] string time) {
