...
namespace DiscordBotEthan.Commands {
    ...
    public class Hackban : BaseCommandModule {
        ...
        public async Task HackbanCommand(CommandContext ctx, [Description("The User to ban (ID, Mention)")] DiscordUser user, [RemainingText, Description("Reason for the Ban")] string reason = "No reason specified") {
            ...
            DiscordEmbedBuilder Hackban = new DiscordEmbedBuilder {
                ...
                Description = $"{user.Mention} **has been banned from the Server for the following Reason:**\n{reason}",
